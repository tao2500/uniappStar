...
(function(vue) {
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(
      ...
      null,
      [
        vue.createElementVNode("p", null, "我是foot组件（自定义组件myAssembly）"),
        vue.createElementVNode(
          "p",
          null,
          "父组件传给子组件的信息：" + vue.toDisplayString($props.msg),
          1
          /* TEXT */
        ),
        vue.createElementVNode("button", {
          type: "primary",
          onClick: _cache[0] || (_cache[0] = (...args) => $options.sendMsg && $options.sendMsg(...args))
        }, "给父组件传值")
      ],
      64
      /* STABLE_FRAGMENT */
  ...
  const PagesMyAssemblyFoot = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/pages/myAssembly/foot.vue"]]);
  const _sfc_main$5 = {
    components: { foot: PagesMyAssemblyFoot },
    data() {
      return {
        msg: "hello-uniapp",
    ...
    methods: {
      clickme(area, e) {
        formatAppLog("log", "at pages/test/test.vue:78", "成功点击参数：" + area + " 事件对象：" + e);
      },
      chooseImg() {
        uni.chooseImage({
          count: 9,
      ...
      getMsg(res) {
        formatAppLog("log", "at pages/test/test.vue:115", "收到子组件传来信息：" + res);
        this.childMsg = res;
      }
    },
    onPullDownRefresh() {
      formatAppLog("log", "at pages/test/test.vue:120", "成功触发页面下拉刷新");
      uni.stopPullDownRefresh();
    },
    onReachBottom() {
      formatAppLog("log", "at pages/test/test.vue:124", "页面触底了");
    }
  };
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", null, [
      ...
      vue.createTextVNode(" " + vue.toDisplayString("false") + " " + vue.toDisplayString(1 + 1) + " "),
      vue.createElementVNode("hr"),
      ...
      vue.createElementVNode("hr"),
      vue.createElementVNode("button", {
        onClick: _cache[0] || (_cache[0] = ($event) => $options.clickme("参数", $event))
      }, "点我"),
      vue.createElementVNode("hr"),
      vue.createTextVNode(" 上传图片： "),
      vue.createElementVNode("view", null, [
        vue.createElementVNode("button", {
          onClick: _cache[1] || (_cache[1] = (...args) => $options.chooseImg && $options.chooseImg(...args)),
          type: "primary"
        }, "上传图片")
      ]),
      vue.createElementVNode("view", null, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList(_ctx.imgArr, (item) => {
      ...
      vue.createElementVNode("hr"),
      vue.createTextVNode(" uniapp中的导航转跳： "),
      vue.createElementVNode("navigator", {
        url: "/pages/navTarget/navTarget",
        "hover-class": "navigator-hover"
      }, [
        vue.createElementVNode("button", { type: "default" }, "跳转到目标页面")
      ]),
      vue.createElementVNode("navigator", {
        url: "/pages/text/text",
        "open-type": "switchTab"
      }, [
        vue.createElementVNode("button", { type: "default" }, "跳转到text页面")
      ]),
      vue.createElementVNode("button", {
        onClick: _cache[2] || (_cache[2] = (...args) => $options.goText && $options.goText(...args))
      }, "navigateTo转跳(不能转跳到选项卡页面)"),
      vue.createElementVNode("button", {
        onClick: _cache[3] || (_cache[3] = (...args) => $options.goText2 && $options.goText2(...args))
      }, "switchTab转跳(不能转跳到普通页面)"),
      vue.createElementVNode("button", {
        onClick: _cache[4] || (_cache[4] = (...args) => $options.goText3 && $options.goText3(...args))
      }, "redirectTo(关闭当前页面转跳,不能转跳选项卡)"),
      vue.createElementVNode("button", {
        onClick: _cache[5] || (_cache[5] = (...args) => $options.goText4 && $options.goText4(...args))
      }, "传参转跳"),
      vue.createElementVNode("br"),
      vue.createElementVNode("hr"),
      vue.createVNode(_component_foot, {
        msg: $data.msg,
        onMyEvent: $options.getMsg
      }, null, 8, ["msg", "onMyEvent"]),
      vue.createElementVNode(
        "p",
        null,
        "收到子组件传来信息：" + vue.toDisplayString($data.childMsg),
        1
        /* TEXT */
      )
    ]);
  }
  const PagesTestTest = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/pages/test/test.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        title: "Hello"
    ...
    onLoad() {
      formatAppLog("log", "at pages/index/index.vue:54", "页面生命周期  onLoad  监听页面加载，其参数为上个页面传递的数据，参数类型为Object（用于页面传参）");
    },
    onShow() {
      formatAppLog("log", "at pages/index/index.vue:64", "页面生命周期 onShow  监听页面显示。页面每次出现在屏幕上都触发，包括从下级页面点返回露出当前页面");
    },
    onReady() {
      formatAppLog("log", "at pages/index/index.vue:67", "页面生命周期 onReady  监听页面初次渲染完成。");
    },
    onHide() {
      formatAppLog("log", "at pages/index/index.vue:70", "页面生命周期 onHide  监听页面隐藏");
    },
    onUnload() {
      formatAppLog("log", "at pages/index/index.vue:73", "页面生命周期 onUnload  监听页面卸载");
    },
    methods: {
      // uni.request({
      //     url: 'http://localhost:1000/user/getAll',
      //     success(res) {
      // 		__f__('log','at pages/index/index.vue:79',res)
      //         __f__('log','at pages/index/index.vue:80','我成功发送了请求')
      //     }
      // 	// 取消请求
      // }).abort();
    }
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
      ...
      vue.createElementVNode("br"),
      vue.createElementVNode("a", { href: "https://developer.aliyun.com/article/1043799#slide-0" }, "学习笔记"),
      vue.createElementVNode("hr"),
      vue.createTextVNode(" 条件注释实现跨端兼容测试： "),
      vue.createElementVNode("br"),
      vue.createElementVNode("view", null, " app会显示 ")
    ]);
  }
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/pages/index/index.vue"]]);
  const _sfc_main$3 = {};
  function _sfc_render$2(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        vue.createElementVNode("view", null, [
          vue.createCommentVNode(" 长按文本是否可选 "),
          vue.createElementVNode("text", { selectable: "true" }, "我嫩爹")
        ]),
        vue.createElementVNode("view", null, [
          vue.createCommentVNode(" 显示连续空格的方式 "),
          vue.createElementVNode("view", null, [
            vue.createElementVNode("text", { space: "ensp" }, "我 嫩爹")
          ]),
          vue.createElementVNode("view", null, [
            vue.createElementVNode("text", { space: "emsp" }, "我 嫩爹")
          ]),
          vue.createElementVNode("view", null, [
            vue.createElementVNode("text", { space: "nbsp" }, "我 嫩爹")
          ])
        ]),
        vue.createElementVNode("view", null, [
          vue.createElementVNode("text", null, "skyblue")
        ]),
        vue.createElementVNode("view", null, [
          vue.createCommentVNode(" 是否解码 "),
          vue.createElementVNode("text", { decode: "true" }, "  < > & '    ")
        ]),
        vue.createElementVNode("br"),
        vue.createTextVNode(" view组件属性测试： "),
        vue.createElementVNode("view", {
          class: "box2",
          "hover-class": "box2_active"
        }, [
          vue.createTextVNode(" 外层view "),
          vue.createElementVNode("view", {
            class: "box1",
            "hover-class": "active",
        ...
        vue.createElementVNode("br"),
        vue.createTextVNode(" buttom组件属性测试： "),
        vue.createElementVNode("button", {
          size: "mini",
          type: "primary"
        }, "前端"),
        ...
        vue.createElementVNode("button", { size: "default" }, "默认按钮独占一行"),
        vue.createElementVNode("br"),
        vue.createTextVNode(" image组件属性测试： 组件默认宽度 300px、高度 225px； "),
        vue.createElementVNode("br"),
        vue.createElementVNode("image", {
          src: "/static/logo.png",
          mode: "heightFix",
        ...
        vue.createElementVNode("hr"),
        vue.createTextVNode(" rpx即响应式px，一种根据屏幕宽度自适应的动态单位。以750宽的屏幕为基准，750rpx恰好为屏幕宽度。屏幕变宽，rpx 实际显示效果会等比放大。 "),
        vue.createElementVNode("br"),
        vue.createTextVNode(" 使用@import语句可以导入外联样式表, 在 uni-app 中不能使用 * 选择器。 ")
      ],
      64
      /* STABLE_FRAGMENT */
    );
  }
  const PagesTextText = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/pages/text/text.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        id: ""
    ...
    methods: {
      setStorage(msg) {
        uni.setStorage({
          ...
          data: msg,
          success() {
            formatAppLog("log", "at pages/storage/storag.vue:40", "存储成功");
          }
        });
      },
      setStor(s2) {
        uni.setStorageSync("id", s2);
      },
      asygetStorage() {
        uni.getStorage({
          key: "id",
      ...
      asyremoveStorage() {
        uni.removeStorage({
          key: "id",
          success: function() {
            formatAppLog("log", "at pages/storage/storag.vue:64", "异步删除成功");
          }
        });
      },
      removeStorage() {
        uni.removeStorageSync("id");
        formatAppLog("log", "at pages/storage/storag.vue:70", "同步删除成功");
      }
    }
  };
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        vue.createElementVNode("view", null, [
          vue.createElementVNode("button", {
            type: "primary",
            onClick: _cache[0] || (_cache[0] = ($event) => $options.setStorage("异步存储的数据"))
          }, "异步存储数据")
        ]),
        vue.createElementVNode("view", null, [
          vue.createElementVNode("button", {
            type: "primary",
            onClick: _cache[1] || (_cache[1] = ($event) => $options.setStor("同步存储的数据"))
          }, "同步存储数据")
        ]),
        vue.createTextVNode(
          " " + vue.toDisplayString($data.id) + " ",
          1
          /* TEXT */
        ),
        vue.createElementVNode("view", null, [
          vue.createElementVNode("button", {
            type: "primary",
            onClick: _cache[2] || (_cache[2] = ($event) => $options.asygetStorage())
          }, "异步获取数据")
        ]),
        vue.createElementVNode("view", null, [
          vue.createElementVNode("button", {
        ...
        vue.createElementVNode("view", null, [
          vue.createElementVNode("button", {
            type: "primary",
            onClick: _cache[4] || (_cache[4] = (...args) => $options.asyremoveStorage && $options.asyremoveStorage(...args))
          }, "异步删除数据")
        ]),
        vue.createElementVNode("view", null, [
          vue.createElementVNode("button", {
            type: "primary",
            onClick: _cache[5] || (_cache[5] = (...args) => $options.removeStorage && $options.removeStorage(...args))
          }, "同步删除数据")
        ])
      ],
      64
  ...
  const PagesStorageStorag = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/pages/storage/storag.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        msg: ""
    ...
    onLoad(options) {
      this.msg = options;
      formatAppLog("log", "at pages/navTarget/navTarget.vue:15", options);
    }
  };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(
      ...
      null,
      [
        vue.createElementVNode("p", null, "这里是navigator的目标页"),
        vue.createElementVNode(
          "p",
          null,
          "收到上一页面参数：" + vue.toDisplayString($data.msg),
          1
          /* TEXT */
        )
      ],
  ...
  const PagesNavTargetNavTarget = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/pages/navTarget/navTarget.vue"]]);
  __definePage("pages/test/test", PagesTestTest);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/text/text", PagesTextText);
  __definePage("pages/storage/storag", PagesStorageStorag);
  __definePage("pages/navTarget/navTarget", PagesNavTargetNavTarget);
  __definePage("pages/myAssembly/foot", PagesMyAssemblyFoot);
  const _sfc_main = {
    onLaunch: function() {
      formatAppLog("log", "at App.vue:4", "uniApp生命周期 onLaunch  当uni-app 初始化完成时触发（全局只触发一次）");
    },
    onShow: function() {
      formatAppLog("log", "at App.vue:7", "uniApp onShow  当 uni-app 启动，或从后台进入前台显示");
    },
    onHide: function() {
      formatAppLog("log", "at App.vue:10", "uniApp onHide  当 uni-app 从前台进入后台");
    },
    onError: function() {
      formatAppLog("log", "at App.vue:13", "uniApp onError  当 uni-app 报错时触发");
    }
  };
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/ASUS/Documents/HBuilderProjects/uniappStar/App.vue"]]);
  ...
  const pages = [
    ...
    {
      path: "pages/storage/storag"
    },
    {
      path: "pages/navTarget/navTarget"
    },
    {
      path: "pages/myAssembly/foot"
    }
  ];
  const globalStyle = {
...
详细信息：${s4}`), r3(i3);
  ...
  let statConfig = {
    appid: "__UNI__E9908B3"
  };
  let titleJsons = {};
  titleJsons = { "pages/test/test": "测试页面", "pages/index/index": "uni-app" };
